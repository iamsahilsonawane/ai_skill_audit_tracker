...
import { Profile, seedUserData } from '@/lib/supabase-utils';
...
interface AuthContextType {
  ...
  loading: boolean;
  signUp: (email: string, password: string, fullName: string, role: 'learner' | 'mentor') => Promise<{ error: Error | null }>;
