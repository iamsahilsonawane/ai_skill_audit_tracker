  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        skill: {
          "not-started": "hsl(var(--skill-not-started))",
          learning: "hsl(var(--skill-learning))",
          confident: "hsl(var(--skill-confident))",
          "can-teach": "hsl(var(--skill-can-teach))",
        },
        mood: {
          struggling: "hsl(var(--mood-struggling))",
          neutral: "hsl(var(--mood-neutral))",
          productive: "hsl(var(--mood-productive))",
          breakthrough: "hsl(var(--mood-breakthrough))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
